 ...
 */
export const isExecuteRequired = (row, propertyKey, mode, propertyDependencies, isVerticalExpandEnabled, condition) => {
    if (!row) {
        return false;
        //No row found
    }
    const shouldRun = condition !== undefined && condition?.trim() !== ""
...
//# sourceMappingURL=isExecuteRequired.js.map