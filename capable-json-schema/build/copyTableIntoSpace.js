...
*/
export const copyTableIntoSpace = async (context) => {
    ...
    path.join(projectRoot, "memory/persons", context.me_personSlug, "files"), realName);
...
//# sourceMappingURL=copyTableIntoSpace.js.map