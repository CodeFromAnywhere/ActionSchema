 ...
 */
export const removeSchemaColumn = async (
  context: StandardContext & { key: string; projectRelativePath: string },
) => {
...
removeSchemaColumn.config = { isPublic: true } satisfies StandardFunctionConfig;
