...
import { FunctionContext, StandardFunctionConfig } from "function-types";
import { humanCase } from "convert-case";

export const signupWithoutDetailsWithContext = async (
...
export const signupGuest = async (authToken: string) => {
