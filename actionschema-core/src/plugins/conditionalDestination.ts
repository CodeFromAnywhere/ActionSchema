...
export const conditionalDestination = async (
...
): Promise<StandardResponse & { result?: ConditionalDestinationResult }> => {
  const { row, destinationTableName, previousResult, ...standardContext } =
    context;
