...
export const actionSchemaCreate = async (context) => {
    const { items, projectRelativePath, shouldExecuteGridEntireRow, totalPriceCredit, ...standardContext } = context;
...
actionSchemaCreate.config = { isPublic: true };
//# sourceMappingURL=actionSchemaCreate.js.map